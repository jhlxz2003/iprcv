...
extern mxml_node_t	*mxmlLoadRawFile(mxml_node_t *top, FILE *fp,
			              mxml_type_t (*cb)(mxml_node_t *));

extern mxml_node_t	*mxmlLoadString(mxml_node_t *top, const char *s,
			                mxml_type_t (*cb)(mxml_node_t *));

extern mxml_node_t	*mxmlLoadRawString(mxml_node_t *top, const char *s,
			                mxml_type_t (*cb)(mxml_node_t *));
...
extern int		mxmlSaveFile(mxml_node_t *node, FILE *fp,
			             int (*cb)(mxml_node_t *, int));
extern int		mxmlSaveRawFile(mxml_node_t *node, FILE *fp,
			             int (*cb)(mxml_node_t *, int));
...
extern int		mxmlSaveRawString(mxml_node_t *node, char *buffer,
			               int bufsize,
			               int (*cb)(mxml_node_t *, int));
